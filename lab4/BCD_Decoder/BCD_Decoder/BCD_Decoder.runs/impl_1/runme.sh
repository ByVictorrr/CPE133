...
HD_PWD='/home/victor/CPE133/lab4/BCD_Decoder/BCD_Decoder/BCD_Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_Decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_Decoder.tcl -notrace
