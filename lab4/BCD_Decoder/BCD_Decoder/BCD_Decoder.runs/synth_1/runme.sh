...
HD_PWD='/home/victor/CPE133/lab4/BCD_Decoder/BCD_Decoder/BCD_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_Decoder.tcl
