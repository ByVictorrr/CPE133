...
HD_PWD='/home/victor/CPE133/lab11/lab11/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_detect_driver.tcl -notrace
