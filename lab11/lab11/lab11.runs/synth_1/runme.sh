...
HD_PWD='/home/victor/CPE133/lab11/lab11/lab11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detect_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_detect_driver.tcl
