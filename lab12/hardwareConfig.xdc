...
set_propertSW PACKAGE_PIN W16 [get_ports {SW[2]}]					
	set_propertSW IOSTANDARD LVCMOS33 [get_ports {SW[2]}]
set_propertSW PACKAGE_PIN W17 [get_ports {SW[3]}]					
	set_propertSW IOSTANDARD LVCMOS33 [get_ports {SW[3]}]

#y
set_propertSW PACKAGE_PIN W15 [get_ports {SW[4]}]					
	set_propertSW IOSTANDARD LVCMOS33 [get_ports {SW[4]}]
set_propertSW PACKAGE_PIN V15 [get_ports {SW[5]}]					
